...
set "TOOL_ROOT=%~dp0"
"%SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe" -NoProfile -ExecutionPolicy Bypass -Command "$root=$env:TOOL_ROOT; $script=Get-ChildItem -LiteralPath $root -Filter 'UninstallClaudeZh.ps1' -Recurse -File | Select-Object -First 1; if(-not $script){ throw 'Cannot find UninstallClaudeZh.ps1. Please keep all files in this folder.' }; & $script.FullName"
